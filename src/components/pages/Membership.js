...
export default () => {
    ...
    const content = 'Collegiate membership may be conferred upon any man, regardless of race, ethnicity, national origin, sexual orientation, disability or religion, who is a student of the sheltering institution. A student shall be eligible if he has met the minimum academic performance standards for successful continuation as a student in good standing as defined by the sheltering institution.';
    return (
        <main>
